...
class start_screen:
    ...
    def __init__(self, root):
        ...
        frm_pp = ttk.LabelFrame(self.ss, borderwidth=5, text = 'Post Processing', padding = p)
        ...
        frm_ses = ttk.LabelFrame(self.ss, borderwidth=5, text = 'SES Output to Process',padding = p)
        ...
        #VISIO Template
        frm_visio = ttk.LabelFrame(self.ss, borderwidth=5, text = 'Visio Template', padding = p)
        ...
        rb_end_time = ttk.Radiobutton(frm_visio, text = 'End', variable = self.rbo_time, value='end')
        rb_user_time = ttk.Radiobutton(frm_visio, text = 'Specified', variable = self.rbo_time, value='user_time')
        ...
        frm_ofl  = ttk.LabelFrame(self.ss, borderwidth=5, text = 'Output File Location', padding = p)
        self.ofl = StringVar(value='ses')
        rb_ses   = ttk.Radiobutton(frm_ofl,text = 'Same as SES Output', variable = self.ofl, value='ses')
        rb_visio = ttk.Radiobutton(frm_ofl,text = 'Same as SES Visio Template', variable = self.ofl, value='visio', state=DISABLED)
        rb_selected =  ttk.Radiobutton(frm_ofl,text = 'Selected', variable = self.ofl, value='Selected', state=DISABLED)
        btn_ofl = ttk.Button(frm_ofl, text='Select', command = self.output_folder, state=DISABLED)
