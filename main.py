...
if __name__ == "__main__":
    ...
    python main.py --settings "{'conversion': '', 'file_type': 'input_file', 'output': ['Excel', 'Visio', '', '', '', '', '', '', ''], 'path_exe': 'C:/Simulations/_Exe/SESV6_32.exe', 'ses_output_str': ['C:/simulations/test/test.inp'], 'simtime': -1, 'visio_template': 'C:/Simulations/Test/Test Template.vsdx'}"
    '''